...
static char *cvs_id="$Id: fitsio.c,v 1.14 2006/12/11 21:17:34 pteuben Exp $ fitsio.c";
...
local string cfits3="nemo::fitsio.c $Id: fitsio.c,v 1.14 2006/12/11 21:17:34 pteuben Exp $";
