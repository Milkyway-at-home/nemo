...
void inipotential (int *npar, double *par, string name)
{
    ...
    if (n>6) vhalo0 = par[6];
    if (n>7) vhaloa1 = par[7];
    if (n>8) vhaloa2 = par[8];
    if (n>9) vhaloa3 = par[9];
    if (n>10) vhaloa4 = par[10];
    if (n>11) vhaloa5 = par[11];
    if (n>12) vhaloa6 = par[12];
    if (n>13) vhaloa7 = par[13];
    if (n>14) vhaloa8 = par[14];
    if (n>15) vhalob1 = par[15];
    if (n>16) vhalob2 = par[16];
    if (n>17) vhalob3 = par[17];
    if (n>18) vhalob4 = par[18];
    if (n>19) vhalob5 = par[19];
    if (n>20) vhalob6 = par[20];
    if (n>21) vhalob7 = par[21];
    if (n>22) vhalob8 = par[22];
    if (n>23) q0 = par[23];
    if (n>24) qa1 = par[24];
    if (n>25) qa2 = par[25];
    if (n>26) qa3 = par[26];
    ...
    if (n>39) qb8 = par[39];
    if (n>40) d = par[40];
    if (n>41) Lvhalo = par[41];
    if (n>42) Lq = par[42];
    if (n>43) warning("mpl: only first 43 parameters recognized");
